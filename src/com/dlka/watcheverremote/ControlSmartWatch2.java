...
//        
       mXBMC = new XBMCClient(String.format("http://192.168.0.1:10/jsonrpc"), "user", "passwd");
    ...
    private void setupClickables(Context context) {
        ...
        if (layout != null) {
            ...
            tv.setOnClickListener(new OnClickListener() {
                ...
                public void onClick() {
                    //mXBMC.showWatch();
                    startApplication("com.vme.watchever");
                }
            });
...
//            }
//        });
        ControlView next = layout.findViewById(R.id.play);
...
//        });
    ...
    private void startApplication(String string) {
		// TODO Auto-generated method stub
    	String name=".activity.StartActivity";
    	 Intent intent = new Intent("android.intent.action.MAIN");
         intent.addCategory("android.intent.category.LAUNCHER");
         intent.setComponent(new ComponentName(string, name));
